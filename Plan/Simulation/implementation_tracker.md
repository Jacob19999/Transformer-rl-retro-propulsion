...
| 14.3  | Implement potential-based shaping: `Φ(s) = -c_d*                                          |         | e_p                      |             | - c_v*                                                                                               |
...
| 14.6  | Implement fuel penalty: `-w_f *                                                            | T_cmd   | /T_max * dt_policy`      | `[ ]`     | `training/reward.py`                                                                               |
| 14.7  | Implement action smoothness penalty: `-w_a *                                               |         | a_t - a_{t-1}            |             | `                                                                                                    |
